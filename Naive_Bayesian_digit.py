...
# Naive Bayesian_cycle.py
# Date: 04/08/2017
# Created by Kaixiang Huang, Yehan Wang
# Implement a advanced feature extraction strategy
...
class NaiveBayesClassifierDigit():
    ...
    def calculate_log_joint_probabilities(self, datum):
        ...
        image_pixels = Feature.cycle_finder(datum)
        for label in self.y_Distribution:
            ...
            log_conditional_probabilities_0 = np.log(max(1 - self.conditional_probabilities[label].all(), 0.001))
